...
void initialize_falling_sand_module(ModuleInitializationLevel p_level) {
    ...
    ClassDB::register_class<FallingSandGrid>();
}
...
extern "C" {
GDExtensionBool GDE_EXPORT falling_sand_library_init(
    ...
    init_object.register_initializer(initialize_falling_sand_module);
    init_object.register_terminator(uninitialize_falling_sand_module);
